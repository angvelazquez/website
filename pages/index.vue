    ...
    <div class="container">
      ...
      <div id="project-cards" :class="{ nonexistent: projectCardsNonexistent }">
        ...
        <div class="row">
          ...
          >
            Applied all object-oriented programming concepts learned in the CSE
            114, Introduction to Object-Oriented Programming, course by using
            Java to create a connect four game that would prompt two players to
            enter a row to drop their designated color into the game board which
            would then stop when a winner is found.
          </project-card>
        ...
        <div class="row">
          ...
          <project-card
            ...
            left-button-text="CSE 114 Class Website"
          >
            Selected to be a TA for the CSE 114, Introduction to Object-Oriented
            Programming, Course. Held two weekly office hours to assist a
            student body of 240 students in their homeworks, exams, and
            projects. Proctored exams being administered to 240 students as well
            as graded multiple exams entirely. Led student lab sessions as well
            as exam review sessions weekly in a class size of 30 students.
          </project-card>
        </div>
